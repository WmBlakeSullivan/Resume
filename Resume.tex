...
% A resaltitem is a complex list element for stuff like projects
...
%%%
%%%  	\ressubitem{Seeking full time employment in the field of software/web application development.}
%%%
%%%  \end{ressection}
%%%%%%%%%%%%%%%%%%%%%%%%
